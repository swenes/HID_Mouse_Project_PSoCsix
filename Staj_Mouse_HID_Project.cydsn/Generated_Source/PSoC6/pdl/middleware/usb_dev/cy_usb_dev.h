...
/**
 * \mainpage Cypress USB Device Middleware Library
*
...
* classes. Also, it allows implementation of other class support. 
* The USB Configurator tool is provided to make it easy to construct the USB 
* Device descriptor.
*
...
* all functions and other declarations in this library. 
* If you are using the ModusToolbox USB Device Configurator, also include cycfg_usbdev.h.
*
* <b>Features:</b>
...
* This function call enables pull-up on D+ to signal USB Device connection on USB Bus. 
* The USB Host detects device connection and starts device enumeration. 
...
*
* \snippet usb_dev/1.0/snippet/main.c snipped_Cy_USB_Dev_InitEnable
*
* \note 
...
********************************************************************************
* 
* The structure of the USB Device is divided into the layers. The implementation 
...
* events to the Class layer. The simplified image is shown below. \n \n
*
...
* 
* The USB Configurator tool provides the User Guide, which can be found  
...
#define CY_USB_DEV_VERSION_MAJOR  (1)

/** USB Device Middleware minor version */
#define CY_USB_DEV_VERSION_MINOR  (0)
...
typedef enum
{
    ...
    CY_USB_DEV_ADDRESS,    /**< Device received address */
...
typedef struct cy_stc_usb_dev_context
{
    ...
    /** Callback for events: bus reset, set configuration ans set interface */
...
{
    class->setConfiguration = callback;
}
...
* received from USB Host but was not recognized. Therefore, this might require manual class 
* processing.
* To remove the callback function, pass a NULL as the function pointer.
*
* \param callback
...
__STATIC_INLINE void Cy_USB_Dev_RegisterClassRequestRcvdCallback(cy_cb_usb_dev_request_received_t callback,
                                                                 cy_stc_usb_dev_class_t           *class)
{
    class->requestReceived = callback;
}
...
__STATIC_INLINE void Cy_USB_Dev_RegisterClassRequestCmpltCallback(cy_cb_usb_dev_request_cmplt_t callback,
                                                                  cy_stc_usb_dev_class_t        *class)
{
    class->requestCompleted = callback;
}
/** \} group_usb_dev_functions_class_support */
